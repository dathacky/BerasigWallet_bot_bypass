(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [3185],
  {
    ...
    4750: function (e, t, s) {
        ...
        let { onClose: t, open: s, time: i } = e,
          ...
          h = (0, a.useCallback)(async () => {
            s &&
              ...
              setTimeout(async () => {
                try {
                  i <= 3500 && (await (0, u.M)('Catch a bee by bot 3s'));
                  let e = await (0, u.pe)({
                    type: 0,
                  });
                  l.setUser(e.user),
                ...
                children: [
                  ...
                  (0, n.jsxs)('div', {
                    ...
                    children: [
                      ...
                      (0, n.jsx)('h4', {
                        className: 'font-bold',
                        children: ''.concat((0, f.CE)(e.amount), ' BEE'),
                      }),
                    ],
                  }),
                  (0, n.jsx)('button', {
                    className: 'btn p-5 w-full',
                    onClick: ((0, d.mI)(), e.onClose()),
                    children: 'Claim',
                  }),
                ],
              }),
      ...
      function y(e) {
        ...
        return (
          (0, a.useEffect)(() => {
            if (s || l) return;
            let e = setTimeout(() => {
              i(!0), r(new Date().getTime()), setTimeout(() => i(!1), 1e4);
            }, (0, f.V6)(15e3, 25e3));
      ...
      function C(e) {
        let { children: t } = e,
          ...
          h = async () => {
            try {
              d(!0), await (0, u.hv)(), window.location.reload();
            } catch (e) {
              d(!1);
            }
          };
    ...
    19429: function (e, t, s) {
      ...
      var n = s(71219),
        a = s(11866);
      s(51267), s(6738), s(36930), s(35800);
      var i = s(79967);
      let l = (0, n.Ue)()(
        (0, a.tJ)(
          (e) => ({
  ...
  function (e) {
    e.O(
      0,
      [
        8218, 6246, 5863, 1267, 8666, 680, 1329, 4930, 4552, 1777, 6930, 2661,
        7702, 177, 1744,
      ],
      function () {
        return e((e.s = 27178));
