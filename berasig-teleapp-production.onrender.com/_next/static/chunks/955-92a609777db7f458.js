...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[955], {
    20955: function(e, t, a) {
        ...
        var n, s, i = a(91153), r = a(11055), l = a(51267), o = a(4930), c = a(76966), d = a(71436), u = a(6738), m = a(25278), p = a(58352), h = a(31592), y = a(7517), f = a(1329), x = a(63114), b = a(9888), g = a(14095), w = a(98431), v = a(36930), k = a(35800), N = a(35804), j = a(30177), B = a(42880), A = {
        ...
        function T(e) {
            ...
            F.c)(e=>e.setCheckBot)
              , P = (0,
            r.useMemo)(()=>new f.BN(I.amountRaw).lt(new f.BN(M)), [I.amountRaw, M])
              , q = (0,
            r.useCallback)(async()=>{
                if (!R)
                ...
                let e = await R.transferNative(D, new f.BN(M))
                  , {txHash: t} = await R.signAndBroadcast(e);
                return await O.invalidateQueries({
    ...
    63114: function(e, t, a) {
        ...
        x.getInstance = e=>{
            let t = i.g[i.q.Bera];
            return new f(e,t,t.decimals)
        }
        ;
        var b = a(86196)
          , g = a(88020);
        let w = ()=>(0,
        n.useMemo)(()=>x.getInstance(g.i.chainId), [])
          , v = ()=>{
            let {currentKey: e} = (0,
            b.kS)()
              , {data: t} = (0,
          ...
          , g = e=>{
            ...
            return {
                ...
                r.useMemo)(()=>t.isNative(e) && s ? s : i ? {
                    ...i,
                    amountRaw: l
                } : a.find(t=>t.tokenAddress === e) || f, [l, i, s, e, t, a]),
                loading: o
            }
        }
          , w = e=>"-"
